...
---
### H1: Booking Channel แต่ละประเภทให้กำไรสุทธิ (Net RevPAR) แตกต่างกันอย่างมีนัยสำคัญ โดย Direct Channel ให้ Net RevPAR สูงกว่า OTA หลังหักค่าคอมมิชชัน
Booking Channels ที่แตกต่างกันส่งผลต่อ Net RevPAR อย่างมีนัยสำคัญ โดยช่องทาง Direct (เช่น Phone, Walk-in) จะให้รายได้สุทธิสูงกว่าช่องทาง OTA เนื่องจากมีภาระต้นทุนค่าคอมมิชชันที่ต่ำกว่า

**เกี่ยวข้องกับ Pain Point:**  
→ มุ่งเน้นการแก้ปัญหา “Revenue Leakage” ที่เกิดจากการพึ่งพาช่องทางตัวแทน (OTA/GDS/Wholesaler) มากเกินไป จนทำให้กำไรสุทธิต่อห้องลดลง แม้โรงแรมจะมี Occupancy สูงก็ตาม

---

### H2: Room Type และ Customer Segment บางกลุ่มมีค่า RevPAR สูงกว่าค่าเฉลี่ยของโรงแรมอย่างมีนัยสำคัญ 
Room Type และ Customer Segment บางกลุ่มมีค่า RevPAR สูงกว่าค่าเฉลี่ยของโรงแรมอย่างมีนัยสำคัญ

**เกี่ยวข้องกับ Pain Point:**  
→ โรงแรมอาจกำลังขายห้องพักให้กับกลุ่มลูกค้าที่สร้างกำไรต่ำ หรือใช้กลยุทธ์ Pricing/Segmentation ที่ไม่เหมาะสม ทำให้สูญเสียโอกาสในการสร้างรายได้สูงสุดจากห้องพักที่มีอยู่

---

### H3: การปรับราคาตามวันในสัปดาห์และฤดูกาล ส่งผลให้ RevPAR เพิ่มขึ้นอย่างมีนัยสำคัญ โดยไม่ลด Occupancy 
การปรับราคาตามวันในสัปดาห์และฤดูกาล ส่งผลให้ RevPAR เพิ่มขึ้นอย่างมีนัยสำคัญ โดยไม่ลด Occupancy

**เกี่ยวข้องกับ Pain Point:**  
→ โรงแรมอาจตั้งราคาต่ำเกินไปในช่วงที่มี Demand สูง (High Demand Period) ส่งผลให้ไม่สามารถดึงศักยภาพรายได้ของห้องพักออกมาได้เต็มที่ เป้าหมายคือการเพิ่ม ADR และ RevPAR โดยยังคงรักษาระดับ Occupancy ไว้ได้

---

### H4: Room Type มี RevPAR ต่ำในวันธรรมดา และยังขาด pricing/promotion ที่เหมาะสม ส่งผลให้ RevPAR โดยรวมของโรงแรมลดลง
Room Type บางประเภทมี RevPAR ต่ำในวันธรรมดา และยังขาด Pricing Strategy หรือ Promotion ที่เหมาะสม ส่งผลให้ RevPAR โดยรวมของโรงแรมลดลง

**เกี่ยวข้องกับ Pain Point:**    
→ ห้องพักบางประเภท โดยเฉพาะห้อง Premium อาจมี Demand ต่ำในช่วงวันธรรมดา ทำให้โรงแรมไม่สามารถสร้างรายได้จาก Inventory ได้เต็มประสิทธิภาพ และเกิดปัญหา Revenue Stagnation ในภาพรวม
